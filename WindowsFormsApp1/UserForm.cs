...
namespace WindowsFormsApp1
{
    public partial class UserForm : Form
    {
        ...
        {
            MessageBox.Show("Изменение информации о пользователе. " +
                "\nВ соответсвующих графах можно изменить имя пользователя, логин. Чтобы изменить пароль, необходимо" +
                "сначала подтвердить старый пароль, а также подтвердить ввод нового пароля. " +
                "\nЕсли необходимо удалить запись, нажмите кнопку \"Удалить учетную запись\". В таком случае снова откроется окно входа, под прежней учетной записью " +
                "войти будет нельзя.");
        }
    }
}
