            ...
            {//
                ...
                {// 
                    ...
                    for (int i = 1; i < cout; i++)
                    {
                        ...
                        other.Write(dataGridView1.Rows[i].Cells[1].Value.ToString() + "#");
                        other.Write(dataGridView1.Rows[i].Cells[2].Value.ToString() + "#");
                        other.Write(dataGridView1.Rows[i].Cells[3].Value.ToString() + "#");
