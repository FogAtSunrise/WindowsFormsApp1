...
namespace WindowsFormsApp1
{
    public partial class HelloForm : Form
    {
        ...
        {
            MessageBox.Show("Регистрация и вход.\n" +
                "Чтобы зарегистрироваться в программе, необходимо ввести имя и логин, которые не превышают по длинне 20 и не меньше 4 символов. " +
                "Так же имя, логин и пароль не должны содержать специальные знаки, такие как: @ # $ и т.д." +
                " Для окончания регистрации, нажмите \"Регистрация\", а затем \"Вход\"." +
                "\n\n Чтобы войти в программу, введите логин и пароль пользователя верно.");
        }
