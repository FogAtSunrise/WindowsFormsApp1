...
namespace WindowsFormsApp1
{
    public partial class AddForm : Form
    {
        ...
        {
            MessageBox.Show(" Для того, чтобы задать промежуток выполнения задачи на \"дневное\" необходимо выбрать время и день в календаре." +
                ...
                "После этого необходимо заполнить графы \"Заголовок\" и \"Описание\". Если необходимо оповещение для задачи, нужно отметить " +
                "галочкой графу \"Оповещения\". Для добавления задачи в список, нажмите \"Добавить\"");
        }
    }   
}
